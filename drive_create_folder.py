...
class ActionsFolderFromGoogleDrive:
    ...
    def __init__(self, service, today_date, site):
        ...
        if isExist is False:
            os.system(
                f"mkdir -p {self.site}/backup-{self.today} && touch list_files.json && mv list_files.json {self.site}/backup-{self.today}"
            )
